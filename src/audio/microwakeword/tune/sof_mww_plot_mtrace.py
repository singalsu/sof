...
def main():
    ...
    parser.add_argument(
        ...
        help="Output PNG image path (default: <input_stem>_mww.png or /home/singalsu/tmp/mww_mtrace.png)"
    )
    parser.add_argument(
    ...
    if args.output is None:
        if args.input == "-":
            ...
            args.output = f"{base}_mww.png" if base != "/home/singalsu/tmp/mtrace" else "/home/singalsu/tmp/mww_mtrace.png"
