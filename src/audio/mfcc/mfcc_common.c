 ...
 *
 * Converts cepstral output (when not in Mel-only mode) from int16 Q9.7
 * to int32 Q9.23 in-place into the shared scratch, sets up the read
 * pointer for staged output and marks the data header as pending.
 *
