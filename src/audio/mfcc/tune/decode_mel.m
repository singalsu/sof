% [mel, t, n, vad, energy, noise_energy, frame_number] = decode_mel(fn, num_mel, hop, fmt, num_channels)
%
% Input
...
%   fmt - format of the Mel data ('s16', 's24', 's32'), determines Q format
%         s16: Q25.7, s24: Q17.15, s32: Q9.23 (all stored as int32)
...
function [mel, t, n, vad, energy, noise_energy, frame_number] = ...
	decode_mel(fn, num_mel, hop, fmt, num_channels)
