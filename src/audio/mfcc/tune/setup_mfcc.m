...
cfg.tplg_fn = '../../../../tools/topology/topology1/m4/mfcc/mfcc_config.m4';
cfg.tplg_ver = 1;
cfg.ipc_ver = 3;
export_mfcc_setup(cfg);

cfg.tplg_fn = '../../../../tools/topology/topology2/include/components/mfcc/default.conf';
cfg.tplg_ver = 2;
cfg.ipc_ver = 4;
export_mfcc_setup(cfg);

wcfg = get_whisper_mel_config();
wcfg.tplg_fn = '../../../../tools/topology/topology2/include/components/mfcc/whisper_mel.conf';
wcfg.tplg_ver = 2;
wcfg.ipc_ver = 4;
